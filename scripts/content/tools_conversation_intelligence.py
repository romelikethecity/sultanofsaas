...
TOOL_CONTENT["gong"] = {
    "overview": [
        ...
        "For teams that commit fully, Gong delivers insights you genuinely can't get anywhere else. Competitive mentions across hundreds of calls. Talk-to-listen ratios by deal stage. The exact moment in a demo where prospects disengage. Custom trackers that flag when reps talk about pricing before establishing value. This is the gold standard in CI, and the feature gap with the next best competitor (Clari or Sybill, depending on the dimension) widens every quarter. The question is whether your team's size and budget justify the gold standard, or whether something 70% as good at 30% of the cost makes more sense.",
    ],
    "expanded_pros": [
        {
        ...
        {
            "title": "Deal intelligence that actually predicts outcomes",
    ...
    "faqs": [
        {"question": "How much does Gong actually cost?", "answer": "Expect $100-160/user/mo plus a $5,000-$10,000/yr platform fee. A 10-person team pays $17,000-$29,200/yr. A 25-person team runs $35,000-$58,000/yr. Gong doesn't publish pricing, so these numbers come from customer reports and sales conversations. Push for annual billing discounts and negotiate the platform fee. Multi-year contracts unlock better per-seat rates. If you're buying 20+ seats, push for 20-30% off list price."},
...
TOOL_CONTENT["chorus"] = {
    ...
    "expanded_pros": [
        ...
        },
        {
            ...
            "detail": "Chorus can pull ZoomInfo contact and company data directly into call context. When a prospect mentions a colleague, Chorus can surface their ZoomInfo profile and org chart position. This integration between call intelligence and contact data is unique to the ZoomInfo ecosystem and genuinely useful for account mapping.",
        },
        {
...
TOOL_CONTENT["clari"] = {
    "overview": [
        "Clari started as a revenue intelligence platform focused on pipeline analytics and forecasting, then expanded into conversation intelligence. It's the reverse path of most CI tools. While Gong started with calls and moved toward deal intelligence, Clari started with deal intelligence and added call recording. The result is the strongest forecasting tool in this category paired with CI features that are good but not best-in-class. Backed by $500M+ in funding and led by Andy Byrne, Clari has carved out a defensible position as the tool CROs trust for pipeline accuracy. Over 1,500 companies use it, including several public companies that consider it core revenue infrastructure.",
    ...
    "expanded_pros": [
        {
            "title": "Best-in-class pipeline analytics and forecasting",
            "detail": "This is Clari's core strength and where it genuinely beats Gong. Pipeline inspection, deal health scoring, forecast accuracy tracking, and revenue leak identification are all deeper in Clari. CROs who live in forecast reviews will find more actionable intelligence here than in any other CI tool. The historical trending data alone helps you see if pipeline is genuinely improving or just reshuffling.",
        },
        {
...
TOOL_CONTENT["sybill"] = {
    "overview": [
        "Sybill took a different approach to conversation intelligence. Instead of building another Gong clone, they focused on what reps actually hate: updating the CRM after calls. Sybill listens to your sales calls, generates AI summaries, and then automatically updates your CRM fields, contact properties, and deal stages based on what was discussed. The CRM writes itself. It's a clever product insight: the #1 complaint from sales managers is that reps don't update the CRM. The #1 complaint from reps is that updating the CRM wastes their selling time. Sybill solves both complaints simultaneously.",
        "The auto-CRM feature is genuinely impressive. After a discovery call, Sybill can populate MEDDIC fields, update next steps, log competitive mentions, and draft a follow-up email. All without the rep touching Salesforce or HubSpot. For teams where CRM hygiene is a constant battle (meaning every sales team that has ever existed), this alone justifies the subscription. Reps save 30-60 minutes per day on admin work they were doing poorly anyway. Managers get CRM data they can actually trust because it's pulled from conversations, not from a rep's fading memory at 6 PM on Friday.",
    ...
    "expanded_pros": [
        {
            "title": "Automatic CRM updates that actually work",
        ...
        },
        {
            ...
            "detail": "Sybill drafts follow-up emails based on what was actually discussed on the call, not generic templates. The emails reference specific topics, action items, and next steps from the conversation. Reps can review, edit, and send in under a minute. The email quality is genuinely better than what most reps write manually because the AI doesn't forget to mention the prospect's key concerns.",
        },
        {
        ...
        {
            "title": "Lighter footprint that reps actually adopt",
    ...
    "pricing_detail": [
        ...
        "No platform fee, no hidden costs, no multi-year contracts required. Sybill's pricing transparency is refreshing in a category where Gong and Clari both require sales conversations to learn what you'll actually pay.",
    ],
    "who_should_buy": [
...
TOOL_CONTENT["fireflies"] = {
    ...
    "expanded_pros": [
        ...
        {
            "title": "Generous free tier that's actually usable",
    ...
    "stage_guidance": {
        "solo": "Start with the free tier. It's genuinely useful for capturing every sales call, prospect meeting, and advisor conversation. Upgrade to Pro ($10/mo) when you hit storage limits or want CRM integration. You'll use Fireflies for years before needing anything more.",
...
TOOL_CONTENT["otter-ai"] = {
    ...
    "verdict_long": [
        "Otter.ai is a good transcription tool that found itself in a conversation intelligence comparison it didn't sign up for. The real-time collaborative editing is genuinely unique and useful for teams that treat meeting transcripts as living documents. The free tier is generous. The pricing is fair. The product does what it promises without overselling.",
...
TOOL_CONTENT["avoma"] = {
    ...
    "who_should_skip": [
        {"audience": "Enterprise sales teams that need depth over breadth", "reason": "At 50+ reps, you need best-in-class coaching (Gong), best-in-class forecasting (Clari), and deep integrations. Avoma's B+ across the board doesn't scale to enterprise requirements where each function needs to be excellent."},
    ...
    "stage_guidance": {
        ...
        "mid_market": "Business plan ($79/user/mo) competes with Gong at half the price. For teams of 15-30, this is worth a serious evaluation. Run a 30-day trial alongside Gong and compare which features your team actually uses. Many mid-market teams find Avoma covers 80% of their needs.",
...
TOOL_CONTENT["fathom"] = {
    "overview": [
        ...
        "The free plan is shockingly generous. Unlimited recordings. Unlimited AI summaries. Unlimited users. No storage caps. No trial period. Fathom makes money by converting power users to the paid plan ($29/user/mo), which adds CRM integration, team features, and custom templates. But the free tier is complete enough that many teams run it for months without upgrading. The company claims over 4 million users, which tracks with its word-of-mouth growth. When a tool is free and genuinely useful, adoption is effortless.",
        "Fathom started as a Zoom-first tool and still works best on Zoom, though it now supports Teams and Google Meet. The interface is clean and fast. Summaries appear within minutes of call completion. The whole experience feels like it was built by people who actually sit in sales calls and got frustrated with existing tools. For individuals and small teams that need great call notes without the overhead of a full CI platform, Fathom is the obvious first choice. It's also the best tool to test whether your team even wants AI meeting intelligence before committing budget to Gong or Sybill.",
    ],
    "expanded_pros": [
        {
            "title": "Genuinely useful free plan with no catches",
        ...
        },
        {
            ...
            "detail": "During or after a call, you can highlight specific moments and share them with teammates via link. This is useful for flagging objections to discuss with managers, sharing product feedback with the engineering team, or sending key moments from customer calls to leadership. The sharing experience is frictionless, requiring no login from the recipient.",
        },
        {
    ...
    "expanded_cons": [
        ...
        },
        {
            ...
            "detail": "The free tier is individual-only. If you want team workspaces, shared call libraries, or manager visibility into rep calls, you need the $29/user/mo plan. For small teams, this means the free tier is really 'free for each person working independently' rather than 'free for teams working together.'",
        },
        {
    ...
    "faqs": [
        {"question": "Is Fathom really free?", "answer": "Yes. Unlimited recordings, unlimited AI summaries, unlimited users. No credit card, no trial period, no storage caps on the free plan. Fathom monetizes through the Standard plan ($29/user/mo) which adds CRM sync and team features. The free product is complete and usable long-term, not a crippled trial. There's no catch. Fathom bets that power users who love the free product will eventually upgrade for team features and CRM integration. It's the same model Slack used to grow. Give away a genuinely useful product, then monetize the upgrade."},
...
TOOL_CONTENT["jiminny"] = {
    ...
    "stage_guidance": {
        ...
        "enterprise": "Jiminny stretches at enterprise scale. The analytics depth, integration library, and brand recognition don't match what 50+ rep teams need. Evaluate Gong as the primary option, with Jiminny as a fallback only if Gong's pricing is truly prohibitive.",
    },
    "alternatives_detail": [
...
TOOL_CONTENT["modjo"] = {
    ...
    "expanded_cons": [
        {
            ...
            "detail": "Modjo's analytics, coaching, and deal intelligence features are 2-3 years behind Gong's in depth and sophistication. The English transcription accuracy is good but not best-in-class. For teams selling primarily in English-speaking markets (US, UK, Australia), Modjo's European advantages don't compensate for the feature gap. You're paying similar prices for a weaker English-market product.",
        },
        {
    ...
    "stage_guidance": {
        ...
        "small_team": "Consider Modjo only if you're a European team selling in multiple EU languages. For a team of 5 selling in French and German across EU markets, Modjo's multi-language support is genuinely useful. For English-only teams, Sybill or Fireflies offer better value.",
    ...
    "faqs": [
        ...
        {"question": "How accurate is Modjo's multi-language transcription?", "answer": "Modjo's transcription accuracy in French, German, and Spanish is consistently reported as superior to Gong's for those languages. English accuracy is good but not best-in-class. Italian and Dutch are functional but less refined. The AI handles language switching within a single call, which is common in European sales conversations where participants may switch between languages mid-sentence. If your primary sales language is non-English European, Modjo's accuracy is a genuine advantage."},
