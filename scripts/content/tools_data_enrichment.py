...
TOOL_CONTENT["clay"] = {
    ...
    "who_should_skip": [
        ...
        {"audience": "Non-technical teams without an ops person", "reason": "Clay requires someone who enjoys building workflows, debugging enrichment sequences, and optimizing credit usage. Without that person, the tool sits at 20% utilization and feels like an expensive spreadsheet."},
