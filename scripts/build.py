...
T("less-annoying-crm", "Less Annoying CRM", "crm", "https://www.lessannoyingcrm.com", 7.4,
  ...
  "$15/user/mo", "budget",
  ["One simple price — no tiers, no upsells", "Incredibly easy to learn", "Best-in-class customer support"],
...
T("notion", "Notion", "project-management", "https://www.notion.so", 7.9,
  ...
  "Free / $8/user/mo", "free",
  ["Best-in-class docs and wikis", "Beautiful, flexible interface", "Strong template ecosystem"],
...
T("constant-contact", "Constant Contact", "email-marketing", "https://www.constantcontact.com", 6.3,
  "A legacy email platform coasting on brand recognition. The event management feature is genuinely useful, but the core email product is outclassed by newer competitors at every price point.",
...
T("mailerlite", "MailerLite", "email-marketing", "https://www.mailerlite.com", 8.0,
  "The best value in email marketing. Clean interface, solid deliverability, and a genuinely useful free tier with 1,000 subscribers. Does 80% of what ConvertKit does at 60% of the price.",
...
T("amplemarket", "Amplemarket", "ai-sdr", "https://www.amplemarket.com", 7.0,
  "An all-in-one AI outbound platform that combines prospecting data, AI writing, and multi-channel delivery. Does everything adequately, nothing exceptionally. The convenience of a single platform offsets the lack of best-in-class depth in any single feature.",
...
T("outreach", "Outreach", "sales-engagement", "https://www.outreach.io", 8.0,
  "The market leader in sales engagement for a reason. The sequencing engine is the most powerful in the category, the AI insights are genuinely useful, and the platform handles everything from SDR prospecting to AE deal management. The price and complexity are real barriers for SMBs.",
  ...
  ["Complex setup requires RevOps support", "Expensive — $100+/user/mo", "Overkill for small teams"],
...
T("reply-io", "Reply.io", "sales-engagement", "https://www.reply.io", 7.2,
  "Multi-channel engagement with strong automation features. Handles email, LinkedIn, calls, and SMS in one platform. The Jason AI feature adds AI-powered prospect research and email writing. Solid mid-market tool — does everything competently without excelling at any single thing.",
  ...
  ["Interface feels cluttered", "AI features are decent but not best-in-class", "Per-user pricing adds up for larger teams"],
...
T("gong", "Gong", "conversation-intelligence", "https://www.gong.io", 8.5,
  ...
  "$100/user/mo", "premium",
  ["Best-in-class conversation analytics", "AI-powered deal intelligence", "Competitive mention tracking"],
  ["Requires 80%+ adoption to justify ROI", "Expensive — $100-160/user/mo + platform fee", "Privacy concerns in some industries"],
...
T("clari", "Clari", "conversation-intelligence", "https://www.clari.com", 7.2,
  "Revenue intelligence and forecasting with conversation data. Clari's pipeline analytics are the strongest in the category — time-series trending and deal risk scoring that actually predict outcomes. The SalesLoft merger (Dec 2025) adds engagement capabilities but creates short-term product uncertainty.",
...
T("sybill", "Sybill", "conversation-intelligence", "https://www.sybill.ai", 7.8,
  ...
  ["Less robust analytics than Gong", "Deal intelligence features are newer", "Smaller ecosystem and fewer integrations"],
...
T("fireflies", "Fireflies.ai", "conversation-intelligence", "https://www.fireflies.ai", 7.5,
  "AI meeting notes that actually work. Joins Zoom, Teams, and Google Meet calls automatically, transcribes everything, and generates searchable summaries. The free tier is generous enough for individual use. Strong for meeting-heavy organizations that need institutional memory, not just sales coaching.",
...
T("avoma", "Avoma", "conversation-intelligence", "https://www.avoma.com", 7.0,
  "An AI meeting assistant that covers the full meeting lifecycle: scheduling, recording, transcription, summaries, and coaching. Tries to be the all-in-one meeting platform. Does each piece adequately without being best-in-class at any single function.",
...
T("fathom", "Fathom", "conversation-intelligence", "https://www.fathom.video", 7.5,
  "Free AI notetaker that punches above its weight. Records Zoom calls, generates summaries, and highlights key moments. The free plan is genuinely usable — no time limits, unlimited recordings. The best entry point for teams trying conversation intelligence before committing to Gong's pricing.",
  "Individual reps and small teams wanting free AI meeting notes",
  "Free / $15/user/mo", "free",
  ["Genuinely useful free plan with unlimited recordings", "Fast, accurate AI summaries", "Clean, simple interface"],
  ["Limited coaching and analytics features", "Less robust than Gong for team-wide insights", "Zoom-first — other platforms are secondary"],
...
T("jiminny", "Jiminny", "conversation-intelligence", "https://www.jiminny.com", 6.5,
  "Revenue intelligence for mid-market teams. Call recording, coaching, and deal intelligence with a focus on adoption. The interface is cleaner than Gong's. Positioned as the CI platform that reps will actually use. Feature depth doesn't match Gong, but neither does the price.",
...
T("zoominfo", "ZoomInfo", "data-enrichment", "https://www.zoominfo.com", 7.5,
  "The most comprehensive B2B database in the market. 100M+ business profiles, intent data, and org charts. The data quality is genuinely better than alternatives. The pricing will make you reconsider your life choices. Minimum $15K/yr contracts with aggressive renewal tactics.",
...
T("clay", "Clay", "data-enrichment", "https://www.clay.com", 8.2,
  "The data enrichment tool that changed the game. Clay doesn't have its own database — it waterfalls across 75+ data providers to find the best data for each contact. The result: better coverage than any single provider. The spreadsheet-like interface handles complex enrichment workflows that would take an engineer to build elsewhere.",
  "RevOps teams and growth operators who want best-in-class data enrichment with workflow flexibility",
  "$149/mo", "mid",
...
T("lusha", "Lusha", "data-enrichment", "https://www.lusha.com", 7.2,
  "Simple contact data lookup that reps actually use. The Chrome extension finds emails and phone numbers from LinkedIn profiles in seconds. Less powerful than ZoomInfo or Clay, but the simplicity and per-seat pricing make it accessible for individual reps and small teams.",
...
T("leadiq", "LeadIQ", "data-enrichment", "https://www.leadiq.com", 7.0,
  ...
  "SDR teams wanting seamless LinkedIn-to-CRM prospecting",
  "$36/user/mo", "budget",
...
NICHES = {
    ...
    'free': {
        ...
        'meta_desc': 'The best free {category_lower} in {year}. Ranked by what the free tier actually gives you — features, limits, and catches.',
        'intro': "Free tiers are marketing tools. Some are genuinely generous. Most are crippled demos designed to make you upgrade. These rankings cut through the marketing and tell you which free plans are worth using long-term.",
        'applies_to': ['crm', 'project-management', 'email-marketing', 'seo-tools', 'help-desk', 'ai-sdr', 'sales-engagement', 'conversation-intelligence', 'data-enrichment'],
        'rankings': {
